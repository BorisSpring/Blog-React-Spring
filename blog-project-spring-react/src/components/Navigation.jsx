...
const Navigation = () => {
  ...
  return (
    <>
      <nav className='flex flex-col md:flex-row justify-between items-center px-5 py-2 container mx-auto md:py-5 relative border-b-2 mb-10 bg-white '>
        ...
        >
          ...
          <BiSearchAlt2 className='text-slate-600 w-5 h-5 ' />
        </div>
        <div className='hidden md:flex md:gap-2'>
          ...
          <div
            className='flex items-center border-l-[2px] border-slate-600 cursor-pointer'
            onClick={() => setIsSearchOpen((prev) => !prev)}
          >
            <BiSearchAlt2 className='text-slate-600 w-5 h-5 ml-3' />
          </div>
        </div>
      </nav>
      <div
